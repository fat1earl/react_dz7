...
*/
const LanguageContext = React.createContext(dictionaries);

const LocalizedText = ({ children }) => (
  <LanguageContext.Consumer>
    {(dictionary) => dictionary[children] || children}
  </LanguageContext.Consumer>
);
...
class LocalizedApp extends React.Component {
  ...
  render() {
    return (
      <LanguageContext.Provider value={dictionaries[this.state.language]}>
        <Col>
          <LanguageSelector
            languages={languages}
